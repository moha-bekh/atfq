...
#[openapi(
    paths(
        ...
        crate::api::user::profile::touch_presence_handler,
        crate::api::user::profile::search_users_handler,
        crate::api::user::profile::list_friends_handler,
        crate::api::user::profile::send_friend_request_handler,
        crate::api::user::profile::accept_friend_request_handler,
        crate::api::user::profile::remove_friend_handler,
    ...
    components(
        schemas(
            ...
            user::profile::FriendTargetRequest,
            user::profile::FriendshipResponse,
            user::profile::FriendListResponse,
            user::profile::PresenceResponse,
            user::profile::UserSearchResult,
            user::profile::UserSearchResponse,
            wiki::articles::GetRootArticlesResponse,
            wiki::articles::NodeBreadcrumbResponse,
            wiki::articles::ArticleResponse,
            wiki::articles::ContributorResponse,
            wiki::articles::ResourceEntry,
